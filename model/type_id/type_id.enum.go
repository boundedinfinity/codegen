...
func Parse(v string) (TypeId, error) {
	f, ok := slicer.FindFn(All, func(x TypeId) bool {
		return TypeId(v) == x
	})
...
func Is(s string) bool {
	return slicer.ContainsFn(All, func(v TypeId) bool {
		return string(v) == s
	})
}
...
func (t TypeId) MarshalYAML() (interface{}, error) {
	return string(t), nil
}

func (t *TypeId) UnmarshalYAML(unmarshal func(interface{}) error) error {
	var v string
