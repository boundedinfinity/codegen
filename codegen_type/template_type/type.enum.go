...
func Parse(v string) (TemplateType, error) {
	f, ok := slicer.FindFn(All, func(x TemplateType) bool {
		return TemplateType(v) == x
	})
...
func Is(s string) bool {
	return slicer.ContainsFn(All, func(v TemplateType) bool {
		return string(v) == s
	})
}
...
func (t TemplateType) MarshalYAML() (interface{}, error) {
	return string(t), nil
}

func (t *TemplateType) UnmarshalYAML(unmarshal func(interface{}) error) error {
	var v string
